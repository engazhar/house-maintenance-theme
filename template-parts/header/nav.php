 ...
 */
$menu_class = \HRAM_THEME\Inc\Menus::get_instance();
$header_menu_id = $menu_class->get_menu_id('hram-header-menu');
            ...
            <?php
              foreach($header_menu_items as $menu_item){
                if(! $menu_item->menu_item_parent){
                  ...
                  $child_menu_item = $menu_class->get_child_menu_items($header_menu_items, $menu_item->ID);
                    ...
                    ?>
                      <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                          <?php
                            foreach($child_menu_item as $child_item){
                              ?>
                              <li>
